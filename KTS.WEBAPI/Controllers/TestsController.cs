...
namespace KTS.WEBAPI.Controllers
{
    ...
    public class TestsController : ControllerBase
    {
        ...
        //{
        //    return await mapper.Map<IEnumerable<TestDTO>, IEnumerable<TestModel>>(_testService.GetAllTests());
        //}
        ...
        //{
        //    var test = await mapper.Map<TestDTO, TestModel>(_testService.GetTestById(id));
